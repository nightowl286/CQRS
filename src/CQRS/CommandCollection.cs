...
public class CommandCollection : DispatchCollection<ICommandRequest, ICommandCollection>, ICommandCollection
{
   ...
   /// <inheritdoc/>
   protected CommandCollection(IServiceScope scope, DispatchCollection<ICommandRequest, ICommandCollection> outerScope) : base(scope, outerScope) { }
   #endregion

   #region Methods
   /// <inheritdoc/>
   public override ICommandCollection CreateScope() => new CommandCollection(_serviceScope.CreateScope(), this);
   #endregion
}
